...
- Learn how to **report multilevel descriptive statistics** in
  `vignette("multilevel-descriptives")` and how to transform them into
  **publication-ready multilevel descriptive tables** in
  `vignette("tables")`.
