...
with **mlstats**. It mimics a study in which 100 participants were asked to
complete a brief daily survey for up to 14 consecutive days; as in most real
mobile diary studies, not everyone completed every day (*N* = 100 persons,
*T* = 5–14 daily observations per person, 1,184 total). The variables are:
...
`decompose_within_between()` makes this easy by adding, by default, two new
