...
- **`_between`**: the group mean (stable between-group component)
- **`_within`**: the deviation from the group mean on each observation
  (within-group fluctuation)
- **`_gmc`**: the grand-mean-centred value (deviation from the sample mean)
