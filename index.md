...
- **Variable decomposition**:
  ...
  splits time-varying predictors into within-group deviations
  (situational fluctuations) and between-group means (stable
  differences), ready for use in REWB models.
